...
mit $0{,}25$ gewichtet; mit $\eta^{-1}=\tfrac{64}{25}$ ergibt sich
\[
  \Bel_1(x) =
  \begin{cases}
...
Korrektur wie in Schritt~1, mit $\eta^{-1}=\tfrac{2500}{931}$. Hier müssen explizit mehrere Fälle
...
($0{,}3$ bzw.\ $0{,}75$) und $\eta^{-1}=\tfrac{1862}{1203}$:
\[
  \Bel_5(x) =
  \begin{cases}
...
Korrektur mit $\eta^{-1}=\tfrac{2500}{931}$:
\[
  \Bel_3(x) =
  \begin{cases}
...
Genauso wie Schritt~3, nur mit den Gegenwahrscheinlichkeiten und $\eta^{-1}=\tfrac{392}{249}$:
\[
  \Bel_5(x) =
  \begin{cases}
