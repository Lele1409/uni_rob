...
TeleopKeyboard::TeleopKeyboard(){
  ...
  get_parameter_or("normal_x", normal_x, 0.5);
  get_parameter_or("normal_y", normal_y, 0.5);
  get_parameter_or("high_x", high_x, 1.0);
  get_parameter_or("high_y", high_y, 1.0);
...
int main(int argc, char** argv)
{
  ...
  std::shared_ptr<TeleopKeyboard> node = std::make_shared<TeleopKeyboard>();
